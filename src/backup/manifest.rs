...
use crate::model::{Platform, Portability, ProfileCategory, SemanticId};
// Scan-output leaf types live in `model`; re-exported so `backup::manifest::Skipped` keeps working.
pub use crate::model::{Collision, SkipReason, Skipped};
